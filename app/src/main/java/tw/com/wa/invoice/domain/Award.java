 ...
 */
public enum Award {
    Veryspecial("E7", AwardInfo.Veryspecial, 8, "特別獎", 1, 1),//特別獎
    Special("E8", AwardInfo.Special, 8, "特獎", 2, 1),//特獎
    Exactsix("E9", AwardInfo.Exactsix, 3, "增開六獎", 9, 1),//額外六


    Top("O1", AwardInfo.Top, 8, "頭獎", 3, 1),//頭獎
    Second("O2", AwardInfo.Second, 7, "二獎", 4, 1),//
    Thrid("O3", AwardInfo.Thrid, 6, "三獎", 5, 1),//
    Fouth("O4", AwardInfo.Fouth, 5, "四獎", 6, 1),//第四講
    Fifth("O5", AwardInfo.Fifth, 4, "五獎", 7, 1),//第五
    Sixth("O6", AwardInfo.Sixth, 3, "六獎", 8, 1),//六
